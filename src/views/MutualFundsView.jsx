          ...
          <div className="flex items-center gap-5 flex-wrap sm:flex-nowrap">
            <div className="flex items-stretch gap-4 bg-slate-900/60 px-4 py-2.5 rounded-2xl border border-slate-800/80">
              ...
              <div className="text-right flex flex-col justify-between">
                ...
                <div className="text-base font-black font-mono text-amber-400">{formatMoney(totalCurrent)}</div>
                ...
                {sortedHoldings.map((h, i) => {
                  ...
                  return (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            <div className="flex items-center gap-1.5 flex-wrap">
                              <span className={`font-bold text-[12px] ${isClosed ? 'text-slate-400 font-medium' : 'text-slate-100 hover:text-amber-400'}`}>
                                {h.name}
                              </span>
                              {isClosed ? (
                      ...
                      <td className="py-3 px-3 text-right font-mono">
                        <div className={`text-[12px] font-bold ${isClosed ? 'text-slate-400 font-medium' : 'text-amber-400 font-black'}`}>
