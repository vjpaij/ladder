...
import { DollarSign, Globe, IndianRupee, ArrowUpRight, Award, Calendar, Search, X, ArrowUpDown, ArrowUp, ArrowDown } from 'lucide-react';
    ...
    <div className="space-y-6 mb-8">
      ...
      <div className="glass-panel p-6 rounded-3xl border border-slate-800/80">
        ...
        <div className="relative w-full md:w-72 mb-4">
          ...
          <input value={search} onChange={(event) => setSearch(event.target.value)} placeholder="Search asset, symbol, market..." className="w-full pl-10 pr-10 py-2 bg-slate-900/80 border border-slate-800 rounded-xl text-xs text-slate-200 focus:outline-none focus:border-emerald-500/50" aria-label="Filter dividend history" />
          {search && (
