...
// -------------------------------------------------------------
app.get('/api/loan/amortization', authenticateToken, async (req, res) => {
  try {
...
app.post('/api/loan/amortization/entry', authenticateToken, async (req, res) => {
  try {
...
app.put('/api/loan/amortization/entry/:id', authenticateToken, async (req, res) => {
  try {
    const { id } = req.params;
...
app.delete('/api/loan/amortization/entry/:id', authenticateToken, async (req, res) => {
  try {
    const { id } = req.params;
...
app.get('/api/reports/mf-holdings', authenticateToken, async (req, res) => {
  try {
    const fxRate = await fetchFxRate();
    const holdings = await db.select('holdings');
...
app.get('/api/reports/growth-benchmarks', authenticateToken, async (req, res) => {
  try {
...
app.post('/api/reports/sync-metadata', authenticateToken, async (req, res) => {
  try {
    invalidateBenchmarkCache();
